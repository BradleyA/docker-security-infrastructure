#!/bin/bash
# 	docker-TLS/create-new-openssl.cnf-tls.sh  3.262.729  2019-06-07T21:29:02.335904-05:00 (CDT)  https://github.com/BradleyA/docker-security-infrastructure  uadmin  six-rpi3b.cptx86.com 3.261  
