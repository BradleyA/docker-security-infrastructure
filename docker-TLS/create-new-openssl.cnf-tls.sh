#!/bin/bash
# 	docker-TLS/create-new-openssl.cnf-tls.sh  3.111.472  2019-01-20T00:05:37.714567-06:00 (CST)  https://github.com/BradleyA/docker-scripts  uadmin  six-rpi3b.cptx86.com 3.110  
