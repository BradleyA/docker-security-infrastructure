#!/bin/bash
# 	docker-TLS/copy-host-2-remote-host-tls.sh  3.279.746  2019-06-09T16:02:24.105998-05:00 (CDT)  https://github.com/BradleyA/docker-security-infrastructure  uadmin  six-rpi3b.cptx86.com 3.278  
# 	   minor update 
