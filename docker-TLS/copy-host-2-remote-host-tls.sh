#!/bin/bash
# 	docker-TLS/copy-host-2-remote-host-tls.sh  3.76.433  2018-11-11T10:23:58.203171-06:00 (CST)  https://github.com/BradleyA/docker-scripts  uadmin  six-rpi3b.cptx86.com 3.75  
