#!/bin/bash
# 	docker-TLS/create-user-tls.sh  3.514.1056  2019-11-26T22:45:24.407106-06:00 (CST)  https://github.com/BradleyA/docker-security-infrastructure.git  uadmin  five-rpi3b.cptx86.com 3.513  
