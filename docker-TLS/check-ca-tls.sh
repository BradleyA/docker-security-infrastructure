#!/bin/bash
# 	docker-TLS/check-ca-tls.sh  3.284.751  2019-06-21T21:17:39.232874-05:00 (CDT)  https://github.com/BradleyA/docker-security-infrastructure  uadmin  six-rpi3b.cptx86.com 3.283  
