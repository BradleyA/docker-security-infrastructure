#!/bin/bash
# 	docker-TLS/copy-user-2-remote-host-tls.sh  3.433.911  2019-09-04T14:27:16.374973-05:00 (CDT)  https://github.com/BradleyA/docker-security-infrastructure  uadmin  three-rpi3b.cptx86.com 3.432-3-gfe57a00  
