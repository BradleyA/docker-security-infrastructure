...
#
echo -e "\n${0} ${LINENO} [INFO]:	Run 'sudo systemctl start dockerd-configuration-file' to start."	1>&2
echo    "${0} ${LINENO} [INFO]:	Run 'sudo systemctl enable dockerd-configuration-file' to start on boot."	1>&2
echo    "${0} ${LINENO} [INFO]:	Run 'sudo systemctl start docker' to start."	1>&2
echo    "${0} ${LINENO} [INFO]:	Run 'sudo systemctl enable docker' to start on boot."	1>&2
