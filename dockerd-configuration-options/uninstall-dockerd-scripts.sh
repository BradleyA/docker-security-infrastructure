#!/bin/bash
# 	dockerd-configuration-options/uninstall-dockerd-scripts.sh  3.267.734  2019-06-07T22:21:17.296753-05:00 (CDT)  https://github.com/BradleyA/docker-security-infrastructure  uadmin  six-rpi3b.cptx86.com 3.266  
