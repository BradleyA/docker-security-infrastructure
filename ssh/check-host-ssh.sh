#!/bin/bash
# 	ssh/check-host-ssh.sh  3.397.865  2019-07-27T22:01:20.489860-05:00 (CDT)  https://github.com/BradleyA/docker-security-infrastructure  uadmin  six-rpi3b.cptx86.com 3.396  
