#!/bin/bash
# 	ssh/check-host-ssh.sh  3.396.864  2019-07-27T21:56:27.432340-05:00 (CDT)  https://github.com/BradleyA/docker-security-infrastructure  uadmin  six-rpi3b.cptx86.com 3.395  
