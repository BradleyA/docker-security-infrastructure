#!/bin/bash
# 	ssh/check-user-ssh.sh  3.412.883  2019-07-27T23:27:40.113109-05:00 (CDT)  https://github.com/BradleyA/docker-security-infrastructure  uadmin  six-rpi3b.cptx86.com 3.411  
