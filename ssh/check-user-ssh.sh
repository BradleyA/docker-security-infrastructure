#!/bin/bash
# 	ssh/check-user-ssh.sh  3.366.834  2019-07-27T15:52:06.727054-05:00 (CDT)  https://github.com/BradleyA/docker-security-infrastructure  uadmin  six-rpi3b.cptx86.com 3.365-1-g0b2e3c6  
