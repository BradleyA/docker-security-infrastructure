#!/bin/bash
# 	ssh/check-user-ssh.sh  3.405.874  2019-07-27T22:28:41.369764-05:00 (CDT)  https://github.com/BradleyA/docker-security-infrastructure  uadmin  six-rpi3b.cptx86.com 3.404  
