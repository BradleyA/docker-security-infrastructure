#!/bin/bash
# 	ssh/check-user-ssh.sh  3.338.805  2019-07-26T21:47:54.565712-05:00 (CDT)  https://github.com/BradleyA/docker-security-infrastructure  uadmin  six-rpi3b.cptx86.com 3.337  
# 	   testing post-commit FVT 
