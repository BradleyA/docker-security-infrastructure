#!/bin/bash
# 	ssh/check-user-ssh.sh  3.417.889  2019-07-27T23:47:08.126569-05:00 (CDT)  https://github.com/BradleyA/docker-security-infrastructure  uadmin  six-rpi3b.cptx86.com 3.416-1-g9f79f7f  
