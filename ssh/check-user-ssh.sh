#!/bin/bash
# 	ssh/check-user-ssh.sh  3.333.800  2019-07-26T21:13:36.338618-05:00 (CDT)  https://github.com/BradleyA/docker-security-infrastructure  uadmin  six-rpi3b.cptx86.com 3.332  
# 	   testing post-commit 
