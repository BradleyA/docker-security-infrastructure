#!/bin/bash
# 	ssh/check-user-ssh.sh  3.334.801  2019-07-26T21:18:04.249821-05:00 (CDT)  https://github.com/BradleyA/docker-security-infrastructure  uadmin  six-rpi3b.cptx86.com 3.333  
# 	   testing post-commit 
