#!/bin/bash
# 	ssh/check-user-ssh.sh  3.332.799  2019-07-26T21:09:18.741636-05:00 (CDT)  https://github.com/BradleyA/docker-security-infrastructure  uadmin  six-rpi3b.cptx86.com 3.331  
# 	   testing post-commit 
