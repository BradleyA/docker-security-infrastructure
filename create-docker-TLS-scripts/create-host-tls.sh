...
echo -e "will help with for systems running Ubuntu 16.04 (systemd) and Ubuntu 14.04 (Upstart).\n"

echo "For systems running Ubuntu 14.04 (Upstart) you can just follow these steps below."
